...
import product from '../Asssets/product-design.png'
      ...
      <div className="wrapper">
        <div className="max-w-7xl mx-auto">
          <div className="">
           ...
           <div className=".. grid grid-cols-1 gap-[71px] p-10 sm:grid-cols-2 md:gap-[71px] p-12 lg:grid-cols-3 mb-10 lg:mb-0 md:mb-0">
