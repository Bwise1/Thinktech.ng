  ...
  return (
      ...
      <div className="wrapper mb-[6rem]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex mb-[21px]">
            <h1 className=' font-TTFb justify-between  text-[22px] text-[#0864B7] '>Website Development</h1>
          </div>
