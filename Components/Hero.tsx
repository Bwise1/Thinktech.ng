...
function Hero() {
  return (
    ...
    <div className="justify-center text-center flex mt-7  sm:flex-row md:flex-rw lg:flex-row">
      <div className=".  py-[0.8rem] group px-4 sm:px-[1.8rem] md:px-[1.8rem] lg:px-[1.8rem] mr-5 lg:mr-3 md:mr-3 sm:mr-3 flex justify-center border-[1.6px] border-[#0864B7]  hover:bg-[#0864B7] hover:text-white transition-all duration-200 cursor-pointer ">

        <div className="font-TTF text-[#0864B7] group-hover:text-white whitespace-nowrap overflow-hidden">LEARN MORE</div>
        
        <div className="ml-[2rem] sm:ml-[1.8rem] md:ml-[1.8rem] lg:ml-[1.8rem] ">
      ...
      <div className=". group a py-[0.8rem] px-4 sm:px-[1.8rem] md:px-[1.8rem] lg:px-[1.8rem] flex justify-center border-[1.6px] border-[#0864B7]  bg-[#0864B7] hover:bg-white transition-all duration-200 cursor-pointer">
