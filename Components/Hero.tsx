...
function Hero() {
  return (
    ...
    <div className="justify-center text-center flex mt-7 flex-col sm:flex-row md:flex-rw lg:flex-row">
      <div className=".  py-[0.8rem] group px-[1.8rem] lg:mr-3 md:mr-3 sm:mr-3 flex justify-center border-[1.6px] border-[#0864B7]  hover:bg-[#0864B7] hover:text-white transition-all duration-200 cursor-pointer mb-4 sm:mb-0 md:mb-0 lg:mb-0">

        <div className="font-TTF text-[#0864B7] group-hover:text-white">LEARN MORE</div>
      ...
      <div className=". group a py-[0.8rem] px-[1.8rem] flex justify-center border-[1.6px] border-[#0864B7]  bg-[#0864B7] hover:bg-white transition-all duration-200 cursor-pointer">
        <div className="group font-TTF text-white group-hover:text-[#0864B7]">ENGAGE US</div>

        <div className=" cursor-pointer ml-[1.8rem]">
        <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
