  ...
  return (
    <div className="container max-w-6xl mx-auto px-5 py-12">
      <div className="text-center pb-8">
        <h1 className="text-5xl font-bold">Terms and Condition</h1>
      </div>
      <p className="mb-6">
        ...
        other intellectual property rights related to it, still belong to CACSA
        group.
      </p>
      <p className="mb-6">
        CACSA group is committed to ensuring that the app is as useful and
      ...
      <p className="mb-6">
        The CACSA app stores and processes personal data that you have provided
        ...
        features and it could mean that the CACSA app won’t work properly or at
        all.
      </p>
      <p className="mb-6">
      ...
      <p className="mb-6">
        You should be aware that there are certain things that CACSA group will
        ...
        Wi-Fi, or provided by your mobile network provider, but CACSA group
      ...
      <p className="mb-6">
        Along the same lines, CACSA group cannot always take responsibility for
        ...
        avail the Service, CACSA group cannot accept responsibility.
      </p>
      <p className="mb-6">
        With respect to CACSA group’s responsibility for your use of the app,
        ...
        make it available to you. CACSA group accepts no liability for any loss,
      ...
      <p className="mb-6">
        ...
        to keep using the app. CACSA group does not promise that it will always
