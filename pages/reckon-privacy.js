  ...
  return (
    <div className="container max-w-6xl mx-auto px-5 py-12">
      <div className="text-center pb-8">
        ...
        <p>Last Updated July 25th, 2024</p>
      </div>
      <div className="flex flex-row flex-wrap">
        <div className="w-full md:w-4/5 ">
          <p className="mb-6">
            Thinktech.ng group built the Reckon app as [open
            source/free/freemium/ad-supported/commercial] app. This SERVICE is
            provided by Thinktech.ng at no cost and is intended for use as is.
          </p>
          <p className="mb-6">
          ...
          <p className="mb-6">
            ...
            our Terms and Conditions, which are accessible at Thinktech.ng unless
          ...
          <p className="mb-6">This policy is effective as of 2024-07-25</p>
